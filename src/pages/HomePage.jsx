...
const HomePage = () => {
  ...
  {habits.length === 0 ? "Add Habits" :
    habits.length === 1 ? "1 Habit" : `${habits.length} Habits`}
          ...
          <button onClick={toggleExpanded} className="flex items-center justify-center bg-FACE8F text-brown-font font-bold py-2 px-4 rounded-2xl border-brown-header-bottom border-2">
              {expanded ? (
    <>
